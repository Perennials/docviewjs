...
/**
 * Reusable template for other views which often look like labels.
 * Both the image and the text are optional.
 * @def mixin View.TLabel
 * @author Borislav Peev <borislav.asdf@gmail.com>
 */

/**
 * @def constructor View.TLabel ()
 */
View.TLabel = function () {
	this._image = null;
	this._text = null;
	this._order = 'ltr';
};

View.TLabel.prototype = {

	/**
	 * @def private var View.TLabel._image
	 * @var View.Img|View.StockImg|null
	 */

	/**
	 * @def private var View.TLabel._text
	 * @var View.Txt|null
	 */

	/**
	 * @def private var View.TLabel._order
	 ...
	 * @def function View.TLabel.setOrder( order )
	 ...
	 * @def function View.TLabel.setText( text )
	 ...
	 * @def function View.TLabel.setTitle( title )
	 * @param string|null
	 ...
	 * @def function View.TLabel.setImage( image, title )
...
Unitest( 'View.TLabel', function () {
	...
	mylabel.extend( View ).mixin( View.TLabel, ResolveMixins( { 'setText': View.TLabel } ) );
	var v = new mylabel();
